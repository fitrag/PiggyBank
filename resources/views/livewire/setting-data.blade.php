<div>
    <div class="bg-gradient-to-t from-violet-700 to-violet-900 flex flex-col justify-center items-center py-16">
        <img src="https://ui-avatars.com/api/?name=Fadila%20Fitra%20Kusuma%20Jaya&background=random" alt="" class="rounded-full border border-[10px] border-purple-900 mb-3">
